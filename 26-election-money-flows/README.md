...
## Phase 2 (June 2026): the century sample, gold, and sectors

- [`deep/presidents.md`](deep/presidents.md) - every president from Coolidge to Trump II on one normalized footing: total-return paths from inauguration (dividends included, via the French market series) and the Sharpe table. Best full-term Sharpe of the century: Eisenhower (1.29). Both Trump terms earn high returns the loud way (Sharpe 0.83 and 0.67 at ~20% volatility). Worst: Hoover (-0.73), Nixon (-0.63), Bush 43 (-0.19).
- [`deep/elections_1928.md`](deep/elections_1928.md) - all 25 presidential elections and 24 midterms since 1928 as per-event panels with stats. The post-midterm pattern strengthens in the deep sample: +11.1% median over the next 120 trading days, positive in 22 of 24 since 1930. New finding: party-flip elections crush realized volatility (falls in 10 of 12) while incumbent holds leave it slightly higher - uncertainty resolution is largest exactly when power changes hands.
- [`deep/gold.md`](deep/gold.md) - gold by president since the 1971 float (Carter +43%/yr, Reagan -3%/yr, Trump II +30%/yr) and the Trump question answered against a baseline: the 2022-24 central-bank era already ran +16% annualized; post-2024-election gold ran +29% - an acceleration on top of a structural trend, with the gold-equity correlation turning positive under Trump II (an allocation bid, not a fear bid). Dollar correlation unchanged at -0.4 in every era.
- [`deep/sectors.md`](deep/sectors.md) - where the money goes inside America. After Trump wins the sector flow league is led by materials and aerospace-defense (+33% of AUM median in 13 weeks, both episodes) with utilities, staples, healthcare and biotech in outflows both times. Across 25 elections since 1928, defense ("Guns") is the most Republican-sensitive industry (+4.2% median 60 days after R wins, 89% hit rate, vs -3.4% after D wins) and semiconductors carry the largest Democratic tilt (-7.2 points R-minus-D). Around wars the rotation is flows-first: defense funds took in +41% of assets in the quarter after the Ukraine invasion and +65% after the 2016 election while tech flows stalled.
