...
And here is the part that matters most: **these 2026 numbers are floors, and they keep moving up.** Of the six big names, five have *already* raised their 2026 guidance during the year — Microsoft lifted calendar-2026 from a ~$100bn run-rate to ~$190bn in a single quarter; Alphabet went $175–185bn to $180–190bn; Meta $115–135bn to $125–145bn; Oracle's *in-progress* FY2026 was stepped up ~$25bn to ~$35bn to ~$50bn and still came in above at $55.7bn; TSMC guided to the high end of its range. Amazon hasn't revised yet but did exactly this last year (2025 crept from $100bn to ~$132bn).

The reason a further raise is the base case, not a tail, is that every one of them is **supply-constrained, not demand-constrained**, with a booked backlog far bigger than a year's capex: Microsoft's commercial RPO is $627bn (+99%), with ~$80bn of Azure orders it says it *can't fulfil* for lack of power and capacity; Alphabet's cloud backlog ~$462bn and it calls itself "compute constrained"; Amazon's AWS backlog $364bn before even counting a $100bn+ Anthropic deal; Oracle's RPO $638bn (+363%) at 97.5% GPU utilisation. All four guide 2027 capex *higher again* — Alphabet's CFO said it will "significantly increase." When a company is turning away booked demand, the spend tends to follow.

The honest counter-weight is that the binding constraint is shifting from willingness to *physics*: power, grid interconnection and data-center construction lead times may cap what actually gets built even if the cheques are written, so the realised number could land below guidance for delivery reasons rather than demand. And the market is starting to push back on the bill — Microsoft had its worst month since 2000 in mid-2026 on AI-payback fear, and both Meta and Amazon stocks fell on the day they raised. So the realistic downside is a *slower* pace, not an absolute cut; a demand-driven cut is the low-probability tail. Net: the arrows on this chart point up.
