...
![positioning](../figures/co_IAMBIC.png)
...
Two competitive fronts. (a) **As a platform:** the L9b structure-prediction layer is commoditizing - open clones (Boltz-1/2, Chai-1, Protenix, OpenFold-3) matched the AlphaFold3 frontier in ~1 year at >1000x lower cost. So NeuralPLexer/Enchant confer speed, not a durable technical moat: the tell Iambic itself cites is program-start-to-IND in ~2 years [disclosed] vs an industry-average ~6 years [reported]. (b) **As a drug:** IAM1363 competes on the HER2 target against T-DXd (Enhertu), tucatinib, zanidatamab. Its edge claims: brain-penetrant (>10x CNS penetration vs approved TKIs [disclosed]), type-II, >5,000-fold HER2-vs-EGFR selectivity, activity in wild-type + mutant HER2. Early Phase 1/1b data (ESMO 2025, Oct): partial responses in 28% (n=18) systemic and 33% (n=3) intracranial at >=960 mg/day [disclosed], including patients pretreated with T-DXd and tucatinib - real but tiny-n, early; activity spans HER2-mutant NSCLC, HER2+ breast/gastric, and settings with no approved HER2-directed TKI/antibody (HER2-mutant renal, HER2-amplified NSCLC/ovarian). The pipeline behind it (now named): **IAM-K1** (KIF18A, allosteric, brain-penetrant; TNBC/ovarian/solid tumors) and **IAM-C1** (CDK2/4 selective dual inhibitor; HR+/HER2- breast) - both preclinical, guided to the clinic near-term - plus an undisclosed neurology program.
...
Coverage is private-company thin, but the newsflow since mid-2025 is unusually dense and one item forces a nuance to the platform-leg call.

- **2026-02-09 [disclosed] - Takeda technology + discovery collaboration, milestones "could exceed $1.7bn."** Multi-year deal on a select set of high-priority small molecules, initially Takeda Oncology and GI/Inflammation. Iambic gets upfront + research-cost + technology-access payments (amounts not disclosed [undisclosed]), success-based milestones potentially >$1.7bn, plus royalties on net sales; Takeda gets access to NeuralPLexer and Iambic's automated wet-lab / Design-Make-Test-Analyze loop. Read: this is a **platform-as-a-service biobuck**, not a platform sale, and it does not de-risk any Phase-II efficacy - but it is a large third-party validation that the discovery-speed edge is externally monetizable. It softens (does not overturn) the "platform leg REFUTED" call: the model is still a ~1-year-commoditizing technical moat, yet a major pharma is paying access fees + milestones for the integrated speed today. Non-dilutive and it stacks on the owned pipeline rather than replacing it.
- **2025-11-10 [disclosed] - over $100m oversubscribed round** (already in Financial summary). Secondary trackers put cumulative funding at ~$334m across 5 rounds / 28 investors [reported] - consistent with the ~$300m+ estimate above. Named use of proceeds: push IAM-K1 (KIF18A) and IAM-C1 (CDK2/4) into the clinic plus further discovery/technology-enablement collaborations.
- **2025-10-21 [disclosed] - Jazz Pharmaceuticals research + drug-supply collaboration.** Jazz supplies zanidatamab (Ziihera) at no cost for an Iambic-sponsored combination cohort (IAM1363 + zanidatamab + capecitabine) in HER2+ breast cancer previously treated with Enhertu, inside the Phase 1/1b IAM1363-01 study (NCT06253871). Non-dilutive reach into a post-Enhertu population; still optionality the pharma partner can envelop, not an owned rail.
- **2025-10 [disclosed] - ESMO 2025 first clinical readout for IAM1363** (detailed above): 28% systemic (n=18) / 33% intracranial (n=3) partial responses at >=960 mg/day in heavily pretreated patients; encouraging safety/PK per company. Tiny-n, early - a hopeful signal, not a franchise.
- **2025-06-04 [disclosed] - dose escalation completed.** Two well-tolerated doses moved into dose optimization; the study is structured toward Simon 2-stage tumor-specific expansion cohorts (Part 3) and IAM1363-combination cohorts (Part 4). Optimization enrollment prioritizes HER2-altered brain-mets, HER2 TKD-mutant, and HER2-amplified NSCLC - i.e. the brain-penetrance/underserved settings where the differentiation claim lives.
- **Net effect on the thesis:** the master variable is unchanged - IAM1363 has cleared the chemistry/Phase-I half but has **zero Phase-II efficacy proof**; the Takeda and Jazz deals move the platform and distribution legs, not the ~40% Phase-II wall. Coverage on valuation remains thin: no post-money mark disclosed at any round.
