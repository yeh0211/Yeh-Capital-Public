...
![positioning](../figures/co_BFLY.png)
...
- **The edge that matters is the chip, not the probe.** BFLY is the one POCUS name that can *license its transducer as a semiconductor IP block* — no crystal competitor can. That is the Embedded thesis and the Midjourney tell.
...
## Core variables
1. **Embedded/chip-licensing ramp and durability.** Is Embedded a real recurring IP-toll business or a handful of lumpy NRE/SOW contracts? Q1'26 was +147% but off a small base and concentration-heavy (Midjourney = the swing factor; the deal is up to **$74m over 5 years**, much of it milestone/consumption-contingent, not booked). This one line carries the re-rate.
