...
![positioning](../figures/co_VCYT.png)
...
- **Prostate (Decipher):** the category leader, guideline-included (NCCN), the anchor franchise. Competes with a large-cap diagnostics rival's Oncotype/Prostate positioning and MDxHealth, but Decipher has the coverage + guideline lead. The evidence gap widened in 2025-2026: Decipher is the only gene-expression test in the NCCN prostate guidelines [reported], achieved Simon Level I evidence status [reported], and a Phase 3 STAMPEDE readout (published in Cell) showed it predicts which metastatic patients benefit from docetaxel intensification [reported] - prospective, randomized evidence a new entrant would need years to replicate.
- **Thyroid (Afirma):** duopoly vs Interpace/ThyroSeq; mature, single-digit-volume growth - the slow-grower in the mix.
- **MRD (TrueMRD, commercial Jun 1 2026):** enters a crowded, faster-moving field vs Natera Signatera (dominant, ~181k units/qtr scale at peers), Guardant, Exact, and Personalis (which already holds Medicare coverage in NSCLC + breast). Veracyte is a late entrant here off a small base, and the incumbent is escalating in TrueMRD's exact launch indication: Signatera won FDA companion-diagnostic (CDx) approval in muscle-invasive bladder cancer in May 2026 [reported] and an NCCN Category 1 recommendation for ctDNA-MRD in bladder in June 2026 [reported]. Veracyte's counter is technical differentiation - it markets TrueMRD as the only whole-genome MRD test [disclosed], vs the tumor-informed-panel approach at incumbents - not a coverage or scale lead.
...
The 2026 print reinforced the "good business" half of the read while leaving the "priced-for-MRD-re-acceleration" half unresolved.

- **Q1'26 beat + raise (May 5 2026) [reported].** Total revenue $139.1m (+21%), testing $135.1m (+26%), both above the ~$132.6m consensus. GAAP net income $28.7m (20.6% margin) vs $7.0m a year earlier; adj EBITDA $42.8m (30.8% margin). ~47,600 tests, +17%. Segment split: Decipher $86.5m (+30%), Afirma $46.4m (+21%) - Afirma re-accelerated from the FY25 +9% pace, and Decipher stayed the growth engine.
- **Guidance raised twice [reported].** FY26 total revenue guide lifted to $582-592m (13-14% growth) from $570-582m; testing revenue to $570-580m (16-18%); adj EBITDA margin to >26% from ~25%. The mid-teens-total / high-teens-testing deceleration framing in the bear case still holds - the raise narrows the gap but does not turn deceleration into acceleration.
- **TrueMRD secured Medicare coverage in muscle-invasive bladder cancer (May 15 2026) [reported]; commercial June 1 2026.** Coverage came via the CMS Molecular Diagnostics Services Program (MolDX) for recurrence monitoring after curative-intent treatment. In the pivotal study TrueMRD flagged recurrence a median of 131 days earlier than imaging [reported]. MIBC is ~25% of new bladder-cancer diagnoses, with up to half of patients recurring within two years [reported]. This is the first MRD revenue leg - real, but launching into a coverage-and-guideline-ahead incumbent (see competition).
- **Signatera escalated in the same indication [reported].** Natera won FDA CDx approval (May 2026) and an NCCN Category 1 ctDNA-MRD recommendation in bladder (June 2026) - directly in TrueMRD's launch indication. The MRD leg is confirmed as a per-test share fight against a scaled, coverage-and-guideline-ahead incumbent, not an open field.
- **Prosigna Breast launched in the US (orderable June 8 2026) [reported].** A second new franchise (early-stage HR+ breast, 10-year recurrence risk), launched before a CMS reimbursement decision, with "a number" of commercial payers already covering to varying degrees [reported]. Adds a breast leg but carries near-term reimbursement uncertainty until a MolDX decision and potential NCCN inclusion.

Net: the core got stronger (beat, raise, Afirma re-accel, deeper Decipher evidence) and the growth frontier got harder (Signatera's bladder CDx/NCCN moves land squarely on TrueMRD's launch indication). The two open variables in the original read - MRD traction and CMS repricing - are unchanged.
