...
![positioning](../figures/co_EXAS.png)
...
Competition:
- **Screening:** Guardant (Shield blood CRC test, cheaper/more convenient draw), Freenome, and the colonoscopy standard-of-care itself. Cologuard's edge = **installed brand + USPSTF grade + permanent Medicare coverage + ~11yr real-world reorder data** - a coverage/adoption moat, not assay novelty.
...
- **MRD / MCED:** Oncodetect (MRD, 2025 launch) and Cancerguard (MCED) enter LATE against Natera Signatera (MRD scale leader), Guardant, Grail - no established edge, small base.
