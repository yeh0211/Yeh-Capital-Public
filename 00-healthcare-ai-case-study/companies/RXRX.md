...
![positioning](../figures/co_RXRX.png)
...
## Core variables
1. **Lead-program clinical readout (the master binary).** Does an owned asset clear a value-inflection readout above the base? Watch REC-617 (CDK7, ovarian), REC-4881 (MEK, FAP — 75% showed polyp reduction, ~43% median at 12wk), REC-1245 (RBM39, early data 1H26). One readout re-rates the name; everything else is second-order.
