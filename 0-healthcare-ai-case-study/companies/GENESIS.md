...
![positioning](../figures/co_GENESIS.png)
...
| Incyte (expanded) | May 2026 | $120m upfront ($80m cash + $40m equity) | over $1bn across 5 targets ($232m/program) | 5 new targets + recurring research funding + royalties |
...
Genesis sits in the generation -> optimization -> candidate-selection span: GEMS generates novel chemistry (L9b), optimizes potency/selectivity/ADMET (L9c), and hands off a nominated development candidate (L9d) to the partner or its own pipeline. What flows OUT: designed molecules / development candidates to Lilly, Gilead, Incyte (and historically Genentech), plus owned preclinical assets. The 2026 owned pipeline (per the company pipeline page) is four programs, all preclinical with nothing in the clinic: (1) the lead - pan-mutant PIK3CA allosteric inhibitors for breast/colorectal cancer, "approaching development candidate nomination" [reported]; (2) a first-in-class cell-death program (anti-apoptotic regulator of the extrinsic pathway), in generation; (3) a "validated immunology" program chasing oral small molecules against targets with proven biologics efficacy, in generation; (4) a first-in-class novel-immunology program (an inflammatory-signaling protein) for autoimmune disease, early [reported]. What flows IN: partner capital + target selections, and NVIDIA compute/methods. It is NOT a tool/reagent vendor - it owns the assets its model designs, the same "model is the door, not the moat" structure as Isomorphic and the gene-editing cohort.
...
- **May 20, 2026 - Incyte expansion, precise terms.** Incyte and Genesis broadened the 2025 pact to at least 5 new Incyte-selected targets. Genesis gets $120m total upfront ($80m cash + $40m equity purchase), recurring research funding for AI training/inference compute, up to $232m per program in preclinical/clinical/regulatory/sales milestones, and over $1bn if all milestones hit across the 5 initial targets - with "several billion dollars" more possible if additional targets are nominated, plus royalties on any approved product [reported]. Cumulative Incyte consideration across the 2025 ($30m upfront) and 2026 deals is ~$150m to date [reported]. Read: this is the hard datapoint the thesis leans on - the one counterparty who has now re-upped twice, taken equity twice, and is funding the compute. It is the strongest revealed-preference signal in the file that the platform earns repeat spend.
- **May 2026 - a partner is now feeding proprietary data into the model.** The expanded deal is structured so Incyte shares its proprietary experimental data to train Genesis' "next-generation GEMS" foundation model for protein-ligand structure/property prediction [reported]. This is the one development that pushes against the Moat-4 "data flywheel refuted" call: it is a live test of whether partner-supplied wet-lab data can buy an edge that public data (Boltz/Chai/Protenix) cannot. Caveat: it is a training-input deal, not evidence the flywheel has bought a single point of Phase-II PoS - the wall is still the wall. Watch it as a hypothesis in progress, not a resolved edge.
- **2025-2026 - rebrand to "Genesis Molecular AI."** The company now presents as Genesis Molecular AI (site moved to genesis.ml); GEMS and the strategy are unchanged. Cosmetic, noted only so the reader is not confused by the new name [reported].
- **2026 pipeline status - still zero clinical assets.** As of 2026 the owned pipeline remains four preclinical programs (PIK3CA lead "approaching development candidate nomination," plus a cell-death program and two immunology programs, all in generation). No IND, nothing in the clinic [reported]. This confirms the central bear point has not changed: the ~40% Phase-II wall is still years and one DC-nomination-then-IND away from being tested - unobservable until ~2028-29 at the earliest.
- **What did NOT change.** No disclosed post-money valuation at any round (the May 2026 $40m equity buy is a primary purchase inside a deal, not a priced round mark) [disclosed as undisclosed]. No product revenue. No AI-discovered drug approved anywhere as of 2026. The model layer still commoditizes toward open clones on a ~12-month horizon. Net effect on the read: the going-concern/optionality signal got stronger (bigger, second Incyte re-up + compute funding + a data-training experiment), but nothing moved the value-forming variable - Phase-II efficacy - so the grade holds.
