...
![positioning](../figures/co_CAI.png)
...
- **Per-assay category leaders:** Foundation Medicine + Guardant (GH) in CGP; **Natera Signatera** in MRD (a franchise CAI does not yet have; CAI's own MRD is still in MolDX technical assessment) [reported]. In MCED, CAI's Caris Detect (launched 2026-07-01) enters a field led by **GRAIL (Galleri)** and pursued by **Guardant (Shield)** and **Exact Sciences** - CAI's claimed edge is ACHIEVE-1 sensitivity/specificity built on WGS/WTS + its >1m-case database, but it is the late entrant into a coverage-gated screening market where reimbursement, not test performance, is the binding constraint [reported]. In blood/tissue CGP, CAI is a credible share gainer (Caris Assure +56-66% YoY volume, ~35-40% tissue-blood attach) [sell-side].
...
3. **Pipeline optionality - MRD + MCED (Caris Detect / ACHIEVE-1).** UPDATE: MCED is no longer purely theoretical - Caris Detect commercially launched 2026-07-01 [reported] after finalizing ACHIEVE-1 on 2026-03-31 (60.3% stage 1-2 sensitivity, 99.2% asymptomatic specificity [disclosed]); MRD runs two tracks (tumor-naive colorectal, in MolDX technical assessment; tumor-informed pan-tumor, stage 1-3 [reported]). Still excluded from the top-line guide and pre-coverage/pre-revenue - launch is not adoption, and screening reimbursement is a multi-year build - but this is the genuine upside CAI has that TEM lacks, and the timeline compressed from "24-36 months out" to "on the market, unproven."
...
Since the base profile, the story moved on three fronts - launches, financing, and reimbursement - while the market stayed skeptical.

- **Q1'26 mix, disclosed [disclosed] (reported May'26).** Revenue $216.2m, +79% YoY; Molecular Profiling $210.8m, +85%; Pharma R&D $5.4m (down from $6.8m). Gross margin 65% (vs 47%). Adj EBITDA +$26.2m - the fourth consecutive positive quarter. FCF +$22.5m. Net loss -$0.5m. Cash ~$825m at quarter-end. Cases 52,800, +15% YoY (tissue ~43,600, blood ~9,200). The call framed clinical ASP +61% YoY (tissue >$4,300, +70%; blood ~$2,500, +14%) - a narrower, more current cut than the FY25 +150% blended figure above, consistent with the reset lapping rather than repeating.
- **MCED is no longer "2+ years out" - it launched.** Caris finalized the ACHIEVE-1 study on 2026-03-31 (60.3% stage 1-2 sensitivity, 99.2% asymptomatic specificity [disclosed]) and commercially launched **Caris Detect**, its multi-cancer early-detection blood test, on **2026-07-01** via a consumer channel partner (Everlywell) [reported]. This is the single biggest change to the pipeline read below: the MCED optionality that the base case excluded and called 2+ years out is now on the market in beta/early-commercial form. It is still pre-coverage and pre-revenue in the guide - launch is not adoption, and screening reimbursement is a multi-year build - but the timeline compressed materially.
- **Two more launches.** **Caris ChromoSeq** (hematologic malignancies, MolDX rate ~$3,228, ~50,000 AML/MDS/MPN addressable) on **2026-04-01**; **MI Clarity** (digital-pathology breast-cancer recurrence risk) on **2026-05-05** [reported]. Breadth is widening from a single tissue-CGP engine toward a therapy-selection + recurrence + early-detection stack on the same molecular/AI foundation.
- **Debt refinanced, cheaper and longer [reported] (Q1'26).** New ~$400m facility (Blue Owl / Blackstone) cuts ~$6m annual interest and pushes maturity to April 2031, with a $300m delayed-draw term loan available - it de-risks the ~$381m debt flagged in Core variables without touching the net-cash position.
- **Reimbursement: PAMA filed, management guiding flat.** Caris submitted under PAMA on 2026-05-01 and states it does not expect downward adjustments; both assays are classified CDLT (not ADLT), on the three-year PAMA cycle [reported]. MI Cancer Seek coverage now spans >225m covered lives (75%+ of tissue volume). Caris Assure completed a New York State submission (pending). This directly addresses core-variable #1 (the CMS-repricing tail) - management's guidance is flat, but it is guidance, not a locked outcome.
- **Commercial build-out.** Sales territories expanded from 82 to 146; ~270 reps toward a ~300 target; >70% of orders electronic; 3,000+ physicians on EMR integrations [reported] - the volume-engine investment behind core-variable #2.
- **Market view stayed cautious.** Stock ~$18.35, ~$5.2bn cap (early Jul'26) [reported]; on 2026-07-06 a sell-side desk cut its PT to $25 from $30 while keeping Outperform [reported]. Consensus is still Buy-tilted with PTs well above spot, but the post-IPO de-rating (from ~$31-35 PTs) held through the launches - the tape is paying for cash, not yet for the pipeline.

**Net read on the developments:** the falsification watch-items are trending the right way (ASP holding at a lower-but-positive rate; PAMA guided flat; MCED launched early, not slipped), but none is settled - Caris Detect adoption/coverage, MRD MolDX assessment, and the FY27 volume hand-off from ASP are all still unproven. The thesis shape is unchanged; the evidence on the pipeline leg improved.
