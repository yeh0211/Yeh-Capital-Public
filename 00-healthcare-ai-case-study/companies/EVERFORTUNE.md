...
![positioning](../figures/co_EVERFORTUNE.png)
...
Competition:
- **vs TW pure-plays**: broadest SaMD-licence portfolio of the listed TW cohort - 53 total device licences (13 US FDA + 22 TFDA + SE-Asia) as of Dec 2025 - vs aetherAI (雲象, digital-pathology-focused), Acer Medical (宏碁智醫, VeriSee DR single-flagship), Amcad (安克, ultrasound CAD). It competes on breadth-of-clearance and the CMUH data pipe.
...
Noise (excluded): the Phison (羣聯) care-robot JV (長聯/長穎, ~41% owned, 2026 mass-production plan) - a separate robotics option, not the SaMD thesis; individual single-licence approvals.
