...
![positioning](../figures/co_ASUS-AICS.png)
...
- **TW large-cap infra siblings:** 廣達 QOCA (2382), 鴻海 CoDocator (2317), 緯創醫學 (3231) — same "ICT parent bolts on medical AI, economics buried" archetype. AICS is differentiated by the coding/HIS admin leg rather than compute/ODM.
...
- **US export leg collapsed:** the flagship 775-US-hospital Miraico rollout ran through Olive AI, which shut down in Nov 2023 (once ~$4bn valuation; core assets sold to Waystar/Humata). The single most-cited international proof point is dead; a Middle-East (Octopian) coding MOU is early-stage.
