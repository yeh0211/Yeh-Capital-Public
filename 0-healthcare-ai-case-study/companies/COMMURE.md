...
![positioning](../figures/co_COMMURE.png)
...
Enterprise SaaS + savings-share (Archetypes 02 + 05). Three revenue engines: (i) RCM / claims-to-cash automation (Athelas + CommureOS - "processes tens of billions in annual claims, 85%+ of revenue-cycle work completed without human intervention") - this is the savings-share/take-rate leg that touches the reimbursement dollar; (ii) ambient AI scribe + autonomous coding (Augmedix-derived, 60+ EHR integrations, per-provider-per-month SaaS) - through 2025-2026 repositioned from "copilot" to agentic "autopilot" via Commure Agents (front-office call/scheduling, referral/prior-auth, discharge, and claims agents) plus point extensions (Dictation, Orchestrator referral-management); (iii) workflow/engagement/RPM/staff-safety point tools (Strongline badges, Engage, Athelas Home - whose fingerstick WBC/neutrophil analyzer took FDA clearance for point-of-care use in Feb-2026, one of the few hard regulatory milestones in the stack). ARR ~$104-105m (2024), +150% YoY, "doubled three consecutive years" to a hundreds-of-millions run-rate by 2025. Capital-light at the software layer, but capital-hungry to assemble: growth is bought (M&A + CVF-funded S&M), not organically compounded - no disclosed profitability, and roll-up integration is a real cost tax.
...
Competition - RCM/L8: Waystar (listed, ~$314m Q1-2026 rev, +22%, bought Iodine for $1.25bn), R1 RCM, plus the incumbent BPO tail - a $90bn+ US RCM market growing ~27% CAGR into AI. Scribe/L6: Abridge (~30% share, 2025 KLAS leader, $5.3bn mark; deployed across 150+ health systems including Mayo Clinic, Johns Hopkins and UPMC, reporting 1m+ clinician conversations weekly [reported]), Ambience ($1.25bn; a commissioned KLAS study of a St. Luke's deployment claimed ~$13,000/clinician/yr from improved HCC/E&M coding, a 41% cut in chart-closure time and 22% more face-time [reported]), Suki, Microsoft/Nuance Dragon Copilot, Nabla - and, decisively, Epic's native AI Charting (launched 4-Feb-2026, ~$80/provider/mo, into orders and diagnoses). The demand backdrop is a land-grab: a 2026 KLAS read has 93% of health systems projecting moderate-to-deep ambient-AI adoption within six months [reported], while acute-care EHR purchasing is contracting ~40% YoY [reported] - a scribe TAM inflating even as the EHR budget it rides on shrinks.
...
The 2025-2026 news confirms the thesis rather than resetting it: the roll-up kept buying breadth and pivoting the scribe from copilot to agent, but no disclosure closes the two open gaps (standalone profitability, NRR-at-price).

- Feb-12-2026: Athelas Home's fingerstick WBC / neutrophil-percentage analyzer received FDA clearance for CLIA-waived point-of-care use (Clozapine ANC monitoring, chemo/immunosuppression) [reported]. A rare hard regulatory milestone; economically a small RPM/device leg, not the L8 rail.
- May-19-2026: the $70m at $7bn post-money round was formalized - led by General Catalyst, with Sequoia, sell-side and Kirkland & Ellis participating [reported]. Restated operating scale: 500+ organizations, 3,000+ care sites, 130+ of the largest US health systems, 60+ EHR integrations, "tens of billions" in annual claims with 85%+ of revenue-cycle work run without a human, and "tens of millions" of clinical appointments a year [disclosed/reported]. No ARR update past the ~$104-105m (2024) figure and no profitability disclosure - the two numbers an outsider needs stayed dark.
- Jun-25-2026: named "Overall NLP Company of the Year" in the 2026 AI Breakthrough Awards (5,000+ nominations) [reported] - marketing signal, not an economic one.
- Jun-30-2026: general availability of Commure Orchestrator, an AI-native referral-management and patient-intake platform (ingests unstructured referrals, extracts clinical/payer data, writes accepted referrals back to the EHR; already live at home-health and ambulatory systems "processing hundreds of thousands of tasks autonomously") [reported]. This extends the agent stack toward the front door of the visit, adjacent to - not yet inside - the L8 claims-to-cash rail.
- Product cadence (2025-2026): Commure Agents commercial launch (Jun-25-2025), Commure Dictation speech-to-cursor (Apr-2026), and the "Healthcare Reset" agentic roadmap - all recasting the enveloped L6 scribe as autonomous workflow labor. Vendor-cited early deployments claim 70-90% automation of targeted workflows [reported, unverified].
- Distribution / EHR-surface wins: Epic Toolbox designation for ambient voice via Haiku (Apr-30-2025); embedded in MEDITECH Expanse Now mobile (Sep-2025, after joining the MEDITECH Alliance Mar-2025); Willis Knighton Health selected Commure as enterprise ambient partner after a seven-specialty pilot (May-2026, 88% of providers reporting reduced chart time) [reported]. Note the tension with the bear case: deeper Epic/MEDITECH integration is the same rented surface into which Epic shipped its ~$80 native substitute.

What did NOT change: no independent RCM take-rate disclosure, no NRR-at-price through a renewal cycle, no audited profitability, and the same-investor-marks-its-own-book structure (General Catalyst leads the equity, funds the sales via CVF, and owns a customer via HATCo/Summa). The 2026 flow is more breadth and more agents on top of an unchanged core question.
