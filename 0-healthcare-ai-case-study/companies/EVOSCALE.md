...
![positioning](../figures/co_EVOSCALE.png)
...
The post-terminal chapter confirms the read rather than reversing it: the capability survived, the standalone toll did not.

- Nov 2025 [reported] - Chan Zuckerberg Biohub / CZI absorbs the team in an undisclosed-terms transaction; ~50 staff and co-founder Rives (now CZI Head of Science) move across. Framed by CZI as bringing "critical AI capabilities in-house"; framed by trade press as the apparent end of the standalone company.
- May 27, 2026 [reported] - seven months after recruiting the team, Biohub releases a "world model of protein biology" - the ESM3 successor line - as three components: ESMC (a language model trained on ~2.8bn sequences), ESMFold2 (structure/complex prediction and binder design), and ESM Atlas (6.8bn sequences and 1.1bn predicted structures mapped to function). The prior EvolutionaryScale continuity is explicit (same ESM lineage, same team).
- License [reported] - the successor models are released free/open for the scientific community, with the ESM line under an MIT license for commercial and non-commercial use. The paid, proprietary Forge API is no longer operated as a standalone commercial product; access migrated to the non-profit biohub.ai platform, with local runs via Hugging Face. Net: the intended toll became a free public good under a non-profit - the commercialization path did not merely close, it inverted.
- Healthcare-AI capability, on the record [reported] - the May-2026 release reports lab-validated protein-binder designs against five disease targets in cancer and immunology (EGFR, PDGFR-beta, PD-L1, CTLA-4, CD45), with hit rates of 36-88% for compact mini-binders and 15-29% for antibody-derived formats, and (for PD-L1) restored T-cell signaling in lab tests; design timelines described as compressed from months/years to days. Real, and directionally impressive - but still a lab-stage design engine upstream of any clinic. The standing bear residual holds: as of 2026 no AI-designed drug is approved, and nothing here has moved the ~40% Phase-II efficacy wall.
- Coverage note - the company was private and never disclosed revenue; post-absorption it is a research program inside a non-profit, not a reporting entity, so financial coverage remains thin by design. No primary post-money was ever released; the ~$1.1bn figure remains an [unverified] secondary-marketplace mark.

Read-through: the single variable that mattered - does the model layer hold a durable, monetizable moat - resolved definitively No. The best evidence is that the acquirer chose to give the successor away free rather than run it as a business.
