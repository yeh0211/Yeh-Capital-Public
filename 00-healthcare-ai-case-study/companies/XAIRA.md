...
![positioning](../figures/co_XAIRA.png)
...
Direct cohort: Isomorphic (Alphabet, the flagship model+pipeline peer), Recursion/Exscientia (the largest-flywheel, worst-clinical-output cautionary tale), Generate Biomedicines and Absci (AI biologics/antibody design), Insilico. Xaira's claimed edge is threefold: the Baker de novo lineage (genuinely frontier protein design), a self-generated causal-perturbation dataset at a scale peers have not published, and an unusually deep drug-development bench (Genentech alumni). Its edge is data-generation + design integration, NOT a defensible model — the model layer is the commoditizing part (open clones caught AF3 in ~1yr at >1000x lower cost, per Ch5).
