...
![positioning](../figures/co_ACERMED.png)
...
- **Regional angle:** the differentiator is SE-Asia device-cert accumulation. The current disclosed footprint is landed in 14 global markets with 500+ clinics/hospitals using the VeriSee suite [reported, 2025]; Thailand is the only market cited with "meaningful" revenue contribution (VeriSee DR in 30+ Thai hospitals) [reported, 2026]; VeriOsteo OP into Indonesia/Thailand; Malaysia via an Intel AI-PC partnership [reported, 2025-03]. Export is the growth story precisely because home reimbursement is blocked.

Product line (as of 2025, expanded from the single-product DR base):
- **VeriSee suite** - now three imaging-triage modules off one fundus/X-ray input: VeriSee DR (diabetic retinopathy, the flagship, ~93% accuracy claimed [reported]), VeriSee AMD (age-related macular degeneration), and VeriSee GLC (suspected-glaucoma screening, the newest add). Same L3-L4 archetype, wider disease surface on the same distribution.
- **VeriOsteo OP** - bone-mineral-density abnormality screening off a chest X-ray, extending the triage playbook beyond ophthalmology.
- **aiMed** - a generative-AI clinical-documentation product (voice/text to structured EMR, HIS/EMR-compatible), launched Sept 2025. This is a DIFFERENT archetype from the SaMD triage line - an ambient-scribe/admin-automation tool, not a per-scan regulated decision aid - and it targets clinician-time cost (cited ~25% of a clinician's day on documentation) rather than the diagnosis gate. It is the first product that does not depend on the shut NHI DR-AI vote.
...
The 2025-2026 news does not change the core read (the NHI gate is still shut), but it does two things: it widens the product surface beyond a single DR product, and it deepens the one export market that actually pays.

- **aiMed launched at IFA 2025, Berlin (2025-09-03)** [reported]. A generative-AI clinical-documentation platform (voice/text to structured EMR) unveiled at Acer's next@acer global event - the company's first product launch in Europe, framed as its move from an Asia-only footprint toward Western markets. Read: this is a deliberate archetype diversification away from the reimbursement-blocked SaMD triage line into an admin-automation tool whose buyer is the hospital's labor-cost budget, not the NHI payment code. Whether it converts to revenue is unproven; no aiMed revenue or pricing has been disclosed.
- **VeriSee GLC (glaucoma) added to the suite (2025)** [reported]. VeriSee is now a three-module ophthalmology-AI platform (DR + AMD + GLC) rather than a single-disease product. More disease surface on the same L3-L4 distribution and the same shut domestic-payment gate - broader, not deeper into the dollar.
- **Footprint restated to 14 global markets, 500+ clinics/hospitals (2025)** [reported], up from the earlier "11 countries / 80+ TW sites" framing. This is a distribution/reference number, not a revenue line; adoption still does not equal NHI payment.
- **Thailand deepened via New Eye Inc. + Upsynergy (2026-05-07)** [reported]. Acer Medical partnered with Thai ophthalmic-equipment distributor New Eye Inc. and Upsynergy to build an integrated device + AI + telemedicine offering; VeriSee DR paired with the ARC-1000 fundus camera went into a government-led telemedicine project across five Phuket-province hospitals, with VeriSee DR cited in 30+ Thai hospitals in total. Thailand remains the single export market with cited meaningful revenue - this is the export-annuity core variable being worked, cert-by-cert, exactly as the thesis expects.
- **FY2025 revenue NT$60.05m** [reported] (net loss NT$29.69m, EPS -1.95), roughly flat-to-up on the prior year and still a fraction of opex; Q1 FY2025 cumulative revenue was NT$11.63m (+11.87% YoY), with March 2025 at NT$3.68m (+45.45% YoY) [reported]. Growth is real in percentage terms but off a tiny base; nothing here inflects the loss.

Net: more products and one deeper export market, but no dated NHI catalyst and no disclosed export or aiMed revenue that changes the loss profile. The binary that governs the domestic re-rate has still not fired.
