...
![positioning](../figures/co_ISM.png)
...
![positioning](../figures/ISM_ISM.png)
...
The one counter-signal to "platform commoditizes": a big-pharma buyer keeps re-underwriting the platform itself, not just the owned asset. Lilly went from a 2023 software license, to a >$100m research/licensing collaboration in Nov 2025, to a **new deal in Mar 2026 worth up to ~$2.75bn ($115m upfront)** for an exclusive worldwide license to a portfolio of Insilico's preclinical oral therapeutics plus joint target-directed R&D [reported]. That is a validating datapoint - a top-3 pharma paying repeatedly for platform-sourced candidates - but it is a **biobuck ceiling, not cash**: the $115m upfront is the only near-certain number; the ~$2.75bn is contingent on multi-year development/regulatory/commercial milestones that mostly never fully vest across the industry. It strengthens the BD-cadence line (Core variable 3), not the moat.
...
- **Lilly deal #3, up to ~$2.75bn [29 Mar 2026, reported].** Lilly took an exclusive worldwide license to a portfolio of Insilico's preclinical oral therapeutics across multiple therapeutic areas, plus joint target-directed R&D. Terms: **$115m upfront** [reported], then development/regulatory/commercial milestones to ~$2.75bn plus tiered royalties. This is the third and largest step in the same relationship (2023 software license -> Nov 2025 >$100m research/licensing collab -> this). Read it as **platform validation and a fresh upfront**, not de-risking - the $115m is the bankable number; the headline is a milestone ceiling, and it does not touch the ~40% Phase-II wall on the owned pipeline.
- **2025 annual results published [29 Mar 2026, disclosed].** Confirms the figures already in this profile: revenue **US$56.24m (-34.5%)**, cash **US$393.3m**, software +23.8% / subscribers +18.3%, 6 new preclinical candidates (28 cumulative), 10 clinical-stage programs, ~$1.3bn new BD in 2025 (~$4.6bn cumulative). The multi-partner deal list (Lilly, Servier, Qilu, China Medical System, Tenacia and others) underscores the point that **the top line is deal flow, not an annuity.**
- **Rentosertib inhalation IND cleared by China CDE [28 Apr 2026, reported].** A second, direct-to-lung formulation of the lead molecule enters the clinic - a Phase I of ~80 subjects (SAD/MAD in healthy volunteers plus an open-label IPF cohort). It is the **13th Insilico program to reach IND** [reported]. Regulatory backdrop on rentosertib: US FDA Orphan Drug Designation (Feb 2023) and China CDE Breakthrough Therapy Designation (May 2025) [reported]. This widens the shot-count on the same target but does not change the master variable - the **oral rentosertib Phase-III remains guided to 2H26** [reported], and no AI-discovered drug is approved as of mid-2026.
- **Tape [7 Jul 2026, reported].** ~HK$35.84, near the low end of the 52-wk range and roughly half the post-IPO high; sell-side average target ~HK$77 (5 buy, 0 sell). The ~2x gap between the tape and the targets is the same disagreement flagged in the expectation read - the desks price the pipeline optionality, the market does not.

Net: the Lilly upfronts and the inhalation IND are genuine, but they move the **funding/cadence** and **shot-count** variables, not the outcome variable. Coverage of the binary (Phase-III efficacy vs the ~40% wall) is unchanged - it remains the single unresolved event the whole equity rests on.
